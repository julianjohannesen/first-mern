...
Now we need to go back to server.js and write the code that will allow Mongoose to talk to Mongo. Here’s the complete server.js script. We’ve marked the new lines.
