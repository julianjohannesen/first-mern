...
This may be a bit confusing. Didn't we just use React to serve a different homepage on port 3000? Yes, we did. So why are we serving two different homepages to two different ports? The answer has to do with the way that modern web applications are structured. This might be a good time to revisit the video we suggested about [REST APIs](https://www.youtube.com/watch?v=FOZtRzY5x8E).
